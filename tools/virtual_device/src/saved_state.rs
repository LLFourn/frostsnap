...
//! drawer. What travels: the seed (the efuse-analog keys), the announced firmware
//! digest, and the flash content — which holds the header the device id derives from,
//! so a restore is the same device.
//! Deliberately NOT here: chain
