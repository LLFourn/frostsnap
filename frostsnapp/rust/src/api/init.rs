...
impl super::Api {
    ...
    pub fn load_sim(
        ...
        // 0 is a valid fleet: the session starts empty and devices arrive at runtime
        // (`DevicePool::add_device`), exactly like plugging hardware into a fresh app.
        ...
        for (i, frames_sink) in frame_sinks.into_iter().enumerate() {
            devices.push(build_device(&router, (i + 1) as u32, i, frames_sink));
        }
